...
public class PltlSolver implements LTLSolver{
    final private String cmd = InitialConfiguration.pltl + " graph";
    ...
    protected PltlSolver(List<Formula<String>> doms, List<Formula<String>> goals) {
        ...
        try  {
            ...
            if (timeoutFlag) {
                ...
                while ((aux = bufferedreader.readLine()) != null) {
                    if (aux.equals("Formula 1: satisfiable")) {
                        ret = LTLCheckResult.SAT;
                        break;
                    } else if (aux.equals("Formula 1: unsatisfiable")) {
